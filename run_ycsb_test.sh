...
# without nemesis
# w1 local
lein run test -t causal-register --time-limit 60 -w w1 -r local --shard-count 2 --nodes-file /home/young/nodes --with-nemesis false --password disalg.root! --concurrency 10 --operation-counts 10000 --write-proportion 0.5 --read-proportion 0.5 --leave-db-running
